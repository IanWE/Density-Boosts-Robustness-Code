...
MALCONV_MODEL_PATH = 'models/malconv/malconv.h5'#malconv.checkpoint'
...
class Classifier:
    def __init__(self, classifier_name):
        ...
        elif classifier_name[:6] == 'remote':
            self.model = RemoteModel(classifier_name, int(classifier_name[6:]))
